...
import { EditButtonRender, DeleteButtonRender, ListButtonRender } from '@Components/form-template/buttonsRender';
        ...
        return (
            <Container className="detailsPage">
                ...
                <div className="detailsInfoSection">
                    ...
                    <DetailsInfoRowRender label="User Type" value={user.userType} />
                </div>
                <br />
                <ListButtonRender
                    onClick={() => {
